...
LABEL_CORE = [
    ...
    "order accuracy and missing items (wrong order, missing, incorrect)",
    ...
    "music volume and selection (music too loud, playlist)",
    "lighting and visibility (dim, bright, ambiance)",
    "temperature and ventilation (AC, draft, hot, cold)",
    "smell and odors (smoke, grease smell, odor)",
    ...
    "menu clarity and descriptions (unclear, pictures, translations)",
    "value for money and price fairness (expensive, overpriced, worth)",
...
PACK_MENU_GENERIC = [
    ...
    "asian stir-fry and rice dishes (fried rice, stir fry, wok)",
...
def _auto_min_topic_size(n_docs: int) -> int:
    ...
    """
    return max(10, int(round(0.04 * n_docs)))
